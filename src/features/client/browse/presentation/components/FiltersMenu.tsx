...
export default function FiltersMenu({ filters, onFiltersChange }: FiltersMenuProps) {
  ...
  return (
    <div className="relative mx-auto w-fit shrink-0">
      <button
        ...
        className={`relative flex items-center justify-center gap-2 rounded-card border px-5 py-3.5 text-sm font-medium shadow-sm ${
          activeCount > 0
