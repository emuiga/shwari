...
const NAV_ITEMS = [
  { label: 'Explore Services', href: '/dashboard', icon: CompassIcon },
  { label: 'Service Requests', href: '/service-requests', icon: ClipboardIcon },
  { label: 'Saved Providers', href: '/saved-providers', icon: BookmarkIcon },
  { label: 'Messages', href: '/messages', icon: ChatIcon },
];

const PROFILE_ITEMS = [
  { label: 'Settings', href: '/settings', icon: SettingsIcon },
  { label: 'My Reviews', href: '/my-reviews', icon: StarIcon },
];
